...
|------------- | ------------- | -------------|
| [**contactCreate**](Contacts.md#contactCreate) | **POST** /workspaces/{workspaceId}/contacts | Create a contact |
| [**contactDelete**](Contacts.md#contactDelete) | **DELETE** /workspaces/{workspaceId}/contacts/{contactId} | Delete a contact |
| [**contactList**](Contacts.md#contactList) | **GET** /workspaces/{workspaceId}/contacts | List contacts |
| [**contactRetrieve**](Contacts.md#contactRetrieve) | **GET** /workspaces/{workspaceId}/contacts/{contactId} | Retrieve a contact |
| [**contactUpdate**](Contacts.md#contactUpdate) | **PUT** /workspaces/{workspaceId}/contacts/{contactId} | Update a contact |


<a name="contactCreate"></a>
# **contactCreate**
> Contact contactCreate(workspaceId, xApiKey, accept, contentType, contact)
...
import com.whispir.api.Contacts;
...
public class Example {
  public static void main(String[] args) {
    ...
    Contacts apiInstance = new Contacts(defaultClient);
    ...
    try {
      Contact result = apiInstance.contactCreate(workspaceId, xApiKey, accept, contentType, contact);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Contacts#contactCreate");
...
### HTTP request headers
 ...
 - **Accept**: application/vnd.whispir.contact-v1+json, application/json
...
# **contactDelete**
> contactDelete(workspaceId, xApiKey, contactId, action)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.contactDelete(workspaceId, xApiKey, contactId, action);
    } catch (ApiException e) {
      System.err.println("Exception when calling Contacts#contactDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **contactList**
> ContactCollection contactList(workspaceId, xApiKey, accept, limit, offset, sortOrder, sortFields, fieldname, customFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ContactCollection result = apiInstance.contactList(workspaceId, xApiKey, accept, limit, offset, sortOrder, sortFields, fieldname, customFields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Contacts#contactList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="contactRetrieve"></a>
# **contactRetrieve**
> Contact contactRetrieve(workspaceId, xApiKey, contactId, accept, fields, sortOrder, sortFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String sortFields = "lastName,jobTitle"; // String | The fields that you require the ordering to be performed on. Multiple fields can be provided, separated by a comma.
    try {
      Contact result = apiInstance.contactRetrieve(workspaceId, xApiKey, contactId, accept, fields, sortOrder, sortFields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Contacts#contactRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **contactUpdate**
> contactUpdate(workspaceId, xApiKey, contactId, accept, contentType, contact)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.contactUpdate(workspaceId, xApiKey, contactId, accept, contentType, contact);
    } catch (ApiException e) {
      System.err.println("Exception when calling Contacts#contactUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
