...
|------------- | ------------- | -------------|
| [**reponseRuleList**](ResponseRules.md#reponseRuleList) | **GET** /workspaces/{workspaceId}/responserules | List response rules |
| [**responseRuleCreate**](ResponseRules.md#responseRuleCreate) | **POST** /workspaces/{workspaceId}/responserules | Create a response rule |
| [**responseRuleDelete**](ResponseRules.md#responseRuleDelete) | **DELETE** /workspaces/{workspaceId}/responserules/{responseRuleId} | Delete a response rule |
| [**responseRuleRetrieve**](ResponseRules.md#responseRuleRetrieve) | **GET** /workspaces/{workspaceId}/responserules/{responseRuleId} | Retrieve a response rule |
| [**responseRuleUpdate**](ResponseRules.md#responseRuleUpdate) | **PUT** /workspaces/{workspaceId}/responserules/{responseRuleId} | Update a response rule |


<a name="reponseRuleList"></a>
# **reponseRuleList**
> ResponseRuleCollection reponseRuleList(workspaceId, xApiKey, accept, limit, offset, sortOrder, sortFields)
...
import com.whispir.api.ResponseRules;
...
public class Example {
  public static void main(String[] args) {
    ...
    ResponseRules apiInstance = new ResponseRules(defaultClient);
    ...
    try {
      ResponseRuleCollection result = apiInstance.reponseRuleList(workspaceId, xApiKey, accept, limit, offset, sortOrder, sortFields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ResponseRules#reponseRuleList");
...
[**ResponseRuleCollection**](ResponseRuleCollection.md)
...
<a name="responseRuleCreate"></a>
# **responseRuleCreate**
> responseRuleCreate(workspaceId, xApiKey, contentType, accept, responseRule)
...
public class Example {
  public static void main(String[] args) {
    ...
    String workspaceId = "9A4C5521FFC7B15B"; // String | The identifier for the workspace.
    String xApiKey = "xApiKey_example"; // String | The API key for authentication.
    String contentType = "application/vnd.whispir.responserule-v1+json"; // String | Application specific mime-type.
    String accept = "application/vnd.whispir.responserule-v1+json"; // String | Application specific mime-type.
    ResponseRule responseRule = new ResponseRule(); // ResponseRule | 
    try {
      apiInstance.responseRuleCreate(workspaceId, xApiKey, contentType, accept, responseRule);
    } catch (ApiException e) {
      System.err.println("Exception when calling ResponseRules#responseRuleCreate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="responseRuleDelete"></a>
# **responseRuleDelete**
> responseRuleDelete(workspaceId, xApiKey, responseRuleId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.responseRuleDelete(workspaceId, xApiKey, responseRuleId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ResponseRules#responseRuleDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="responseRuleRetrieve"></a>
# **responseRuleRetrieve**
> ResponseRule responseRuleRetrieve(workspaceId, xApiKey, accept, responseRuleId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String responseRuleId = "64BC5314665B947B"; // String | Response Rule Id
    try {
      ResponseRule result = apiInstance.responseRuleRetrieve(workspaceId, xApiKey, accept, responseRuleId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ResponseRules#responseRuleRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="responseRuleUpdate"></a>
# **responseRuleUpdate**
> responseRuleUpdate(workspaceId, xApiKey, contentType, accept, responseRuleId, responseRule)
...
public class Example {
  public static void main(String[] args) {
    ...
    String accept = "application/vnd.whispir.responserule-v1+json"; // String | Application specific mime-type.
    String responseRuleId = "64BC5314665B947B"; // String | Response Rule Id
    ResponseRule responseRule = new ResponseRule(); // ResponseRule | Response Rules object used to update Response Rules
    try {
      apiInstance.responseRuleUpdate(workspaceId, xApiKey, contentType, accept, responseRuleId, responseRule);
    } catch (ApiException e) {
      System.err.println("Exception when calling ResponseRules#responseRuleUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
