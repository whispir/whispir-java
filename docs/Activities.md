...
|------------- | ------------- | -------------|
| [**activityCreate**](Activities.md#activityCreate) | **POST** /activities | Create an activity |
| [**activityList**](Activities.md#activityList) | **GET** /activities | List activities |
| [**activityWorkspaceList**](Activities.md#activityWorkspaceList) | **GET** /workspaces/{workspaceId}/activities | List workspace activities |


<a name="activityCreate"></a>
# **activityCreate**
> Activity activityCreate(xApiKey, contentType, accept, activity)
...
import com.whispir.api.Activities;
...
public class Example {
  public static void main(String[] args) {
    ...
    Activities apiInstance = new Activities(defaultClient);
    ...
    try {
      Activity result = apiInstance.activityCreate(xApiKey, contentType, accept, activity);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Activities#activityCreate");
...
# **activityList**
> ActivityCollection activityList(xApiKey, accept, limit, offset, sortOrder, sortFields, action, module, user, workspace, status, description, startTime, endTime)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ActivityCollection result = apiInstance.activityList(xApiKey, accept, limit, offset, sortOrder, sortFields, action, module, user, workspace, status, description, startTime, endTime);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Activities#activityList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="activityWorkspaceList"></a>
# **activityWorkspaceList**
> ActivityCollection activityWorkspaceList(workspaceId, xApiKey, accept, limit, offset, sortOrder, sortFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String sortFields = "lastName,jobTitle"; // String | The fields that you require the ordering to be performed on. Multiple fields can be provided, separated by a comma.
    try {
      ActivityCollection result = apiInstance.activityWorkspaceList(workspaceId, xApiKey, accept, limit, offset, sortOrder, sortFields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Activities#activityWorkspaceList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
