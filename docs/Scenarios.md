...
|------------- | ------------- | -------------|
| [**scenarioCreate**](Scenarios.md#scenarioCreate) | **POST** /workspaces/{workspaceId}/scenarios | Create a scenario |
| [**scenarioDelete**](Scenarios.md#scenarioDelete) | **DELETE** /workspaces/{workspaceId}/scenarios/{scenarioId} | Delete a scenario |
| [**scenarioList**](Scenarios.md#scenarioList) | **GET** /workspaces/{workspaceId}/scenarios | List scenarios |
| [**scenarioRetrieve**](Scenarios.md#scenarioRetrieve) | **GET** /workspaces/{workspaceId}/scenarios/{scenarioId} | Retrieve a scenario |
| [**scenarioRunCreate**](Scenarios.md#scenarioRunCreate) | **POST** /workspaces/{workspaceId}/scenarios/{scenarioId} | Run a scenario |
| [**scenarioUpdate**](Scenarios.md#scenarioUpdate) | **PUT** /workspaces/{workspaceId}/scenarios/{scenarioId} | Update a scenario |


<a name="scenarioCreate"></a>
# **scenarioCreate**
> scenarioCreate(workspaceId, xApiKey, contentType, accept, scenario)
...
import com.whispir.api.Scenarios;
...
public class Example {
  public static void main(String[] args) {
    ...
    Scenarios apiInstance = new Scenarios(defaultClient);
    ...
    try {
      apiInstance.scenarioCreate(workspaceId, xApiKey, contentType, accept, scenario);
    } catch (ApiException e) {
      System.err.println("Exception when calling Scenarios#scenarioCreate");
...
|-------------|-------------|------------------|
| **201** | Created |  * Content-Type -  <br>  * Content-Length -  <br>  * Access-Control-Allow-Origin -  <br>  * Cache-Control -  <br>  * Expires -  <br>  * Location - The URI to fetch details of the scenario. <br>  |
...
<a name="scenarioDelete"></a>
# **scenarioDelete**
> scenarioDelete(workspaceId, xApiKey, scenarioId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.scenarioDelete(workspaceId, xApiKey, scenarioId);
    } catch (ApiException e) {
      System.err.println("Exception when calling Scenarios#scenarioDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="scenarioList"></a>
# **scenarioList**
> ScenarioCollection scenarioList(workspaceId, xApiKey, accept, limit, offset, sortOrder, sortFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ScenarioCollection result = apiInstance.scenarioList(workspaceId, xApiKey, accept, limit, offset, sortOrder, sortFields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Scenarios#scenarioList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**ScenarioCollection**](ScenarioCollection.md)
...
### HTTP request headers
 ...
 - **Content-Type**: Not defined
 - **Accept**: application/vnd.whispir.scenario-v1+json, application/json
...
<a name="scenarioRetrieve"></a>
# **scenarioRetrieve**
> Scenario scenarioRetrieve(workspaceId, xApiKey, accept, scenarioId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Scenario result = apiInstance.scenarioRetrieve(workspaceId, xApiKey, accept, scenarioId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Scenarios#scenarioRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="scenarioRunCreate"></a>
# **scenarioRunCreate**
> scenarioRunCreate(workspaceId, xApiKey, contentType, accept, scenarioId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String scenarioId = "41048D9483C8CF2A"; // String | Enter Scenarios id.
    try {
      apiInstance.scenarioRunCreate(workspaceId, xApiKey, contentType, accept, scenarioId);
    } catch (ApiException e) {
      System.err.println("Exception when calling Scenarios#scenarioRunCreate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **202** | Accepted |  * Access-Control-Allow-Origin -  <br>  * Cache-Control -  <br>  * Expires -  <br>  * Location - The URI to fetch details of the scenario. <br>  * Content-Type -  <br>  * Content-Length -  <br>  |
| **400** | Invalid or missing request parameters.  Inspect the request parameters and ensure that all required parameters are supplied.  Note the error text in the response and update the request accordingly. |  * Access-Control-Allow-Origin -  <br>  * Content-Length -  <br>  * Content-Type -  <br>  * Cache-Control -  <br>  * Expires -  <br>  |
| **401** | Invalid or no credentials passed in the request.  Inspect the authorisation header and ensure that a valid authentication has been provided. |  * Access-Control-Allow-Origin -  <br>  * Content-Length -  <br>  * Content-Type -  <br>  * Cache-Control -  <br>  * Expires -  <br>  |
| **403** | Authorisation credentials passed and accepted but the account doesn&#39;t have permission.  * Inspect the authorisation header and ensure that a valid authentication has been provided. * Returned when HTTP is used instead of HTTPS. * Returned when invalid API key is used. * Returned when you have tried to make more API calls than your allowed quota (QPS). Refer to API rate limits. |  * Access-Control-Allow-Origin -  <br>  * Content-Length -  <br>  * Content-Type -  <br>  * Cache-Control -  <br>  * Expires -  <br>  |
| **404** | The requested URL doesn&#39;t exist.  The requested resource was not found. Inspect the ID in the URL that was used and ensure that it&#39;s valid.  Also, inspect the Accept and Content-Type headers that are being used to make sure they’re correct for the URL that is being requested. |  * Access-Control-Allow-Origin -  <br>  * Content-Length -  <br>  * Content-Type -  <br>  * Cache-Control -  <br>  * Expires -  <br>  |
...
<a name="scenarioUpdate"></a>
# **scenarioUpdate**
> scenarioUpdate(workspaceId, xApiKey, contentType, accept, scenarioId, scenario)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.scenarioUpdate(workspaceId, xApiKey, contentType, accept, scenarioId, scenario);
    } catch (ApiException e) {
      System.err.println("Exception when calling Scenarios#scenarioUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
