...
|------------- | ------------- | -------------|
| [**getWorkspaces**](WorkspacesApi.md#getWorkspaces) | **GET** /workspaces | List workspaces |
| [**getWorkspacesById**](WorkspacesApi.md#getWorkspacesById) | **GET** /workspaces/{workspaceId} | Retrieve a workspace |
| [**postWorkspaces**](WorkspacesApi.md#postWorkspaces) | **POST** /workspaces | Create a workspace |
| [**putWorkspaceById**](WorkspacesApi.md#putWorkspaceById) | **PUT** /workspaces/{workspaceId} | Update a workspace |


<a name="getWorkspaces"></a>
# **getWorkspaces**
> GetWorkspaces200Response getWorkspaces(xApiKey, accept, limit, offset, sortOrder, sortFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetWorkspaces200Response result = apiInstance.getWorkspaces(xApiKey, accept, limit, offset, sortOrder, sortFields);
...
<a name="getWorkspacesById"></a>
# **getWorkspacesById**
> Workspace getWorkspacesById(workspaceId, xApiKey, accept)
...
public class Example {
  public static void main(String[] args) {
    ...
    String accept = "application/vnd.whispir.workspace-v1+json"; // String | Application specific mime-type.
    try {
      Workspace result = apiInstance.getWorkspacesById(workspaceId, xApiKey, accept);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkspacesApi#getWorkspacesById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **postWorkspaces**
> Workspace postWorkspaces(xApiKey, contentType, accept, workspace)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Workspace result = apiInstance.postWorkspaces(xApiKey, contentType, accept, workspace);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkspacesApi#postWorkspaces");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="putWorkspaceById"></a>
# **putWorkspaceById**
> Workspace putWorkspaceById(workspaceId, xApiKey, contentType, accept, workspace)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Workspace result = apiInstance.putWorkspaceById(workspaceId, xApiKey, contentType, accept, workspace);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkspacesApi#putWorkspaceById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **204** | Example workspace object response |  * Content-Type -  <br>  * Content-Length -  <br>  * Access-Control-Allow-Origin -  <br>  * Cache-Control -  <br>  * Expires -  <br>  * Location - The URI to fetch details of the resource. <br>  |
| **400** | Invalid or missing request parameters.  Inspect the request parameters and ensure that all required parameters are supplied.  Note the error text in the response and update the request accordingly. |  * Access-Control-Allow-Origin -  <br>  * Content-Length -  <br>  * Content-Type -  <br>  * Cache-Control -  <br>  * Expires -  <br>  |
| **401** | Invalid or no credentials passed in the request.  Inspect the authorisation header and ensure that a valid authentication has been provided. |  * Access-Control-Allow-Origin -  <br>  * Content-Length -  <br>  * Content-Type -  <br>  * Cache-Control -  <br>  * Expires -  <br>  |
| **403** | Authorisation credentials passed and accepted but the account doesn&#39;t have permission.  * Inspect the authorisation header and ensure that a valid authentication has been provided. * Returned when HTTP is used instead of HTTPS. * Returned when invalid API key is used. * Returned when you have tried to make more API calls than your allowed quota (QPS). Refer to API rate limits. |  * Access-Control-Allow-Origin -  <br>  * Content-Length -  <br>  * Content-Type -  <br>  * Cache-Control -  <br>  * Expires -  <br>  |
| **404** | The requested URL doesn&#39;t exist.  The requested resource was not found. Inspect the ID in the URL that was used and ensure that it&#39;s valid.  Also, inspect the Accept and Content-Type headers that are being used to make sure they’re correct for the URL that is being requested. |  * Access-Control-Allow-Origin -  <br>  * Content-Length -  <br>  * Content-Type -  <br>  * Cache-Control -  <br>  * Expires -  <br>  |
