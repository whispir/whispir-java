...
|------------- | ------------- | -------------|
| [**contactCreate**](ContactsApi.md#contactCreate) | **POST** /workspaces/{workspaceId}/contacts | Create a contact |
| [**contactDelete**](ContactsApi.md#contactDelete) | **DELETE** /workspaces/{workspaceId}/contacts/{contactId} | Delete a contact |
| [**contactList**](ContactsApi.md#contactList) | **GET** /workspaces/{workspaceId}/contacts | List contacts |
| [**contactRetrieve**](ContactsApi.md#contactRetrieve) | **GET** /workspaces/{workspaceId}/contacts/{contactId} | Retrieve a contact |
| [**contactUpdate**](ContactsApi.md#contactUpdate) | **PUT** /workspaces/{workspaceId}/contacts/{contactId} | Update a contact |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ContactsApi#contactRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
