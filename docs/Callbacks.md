...
|------------- | ------------- | -------------|
| [**callbackCallList**](Callbacks.md#callbackCallList) | **GET** /callbacks/{callbackId}/calls | List callback calls |
| [**callbackCallUpdate**](Callbacks.md#callbackCallUpdate) | **PUT** /callbacks/{callbackId}/calls | Update a callback call status |
| [**callbackCreate**](Callbacks.md#callbackCreate) | **POST** /callbacks | Create a callback |
| [**callbackDelete**](Callbacks.md#callbackDelete) | **DELETE** /callbacks/{callbackId} | Delete a callback |
| [**callbackList**](Callbacks.md#callbackList) | **GET** /callbacks | List callbacks |
| [**callbackRetrieve**](Callbacks.md#callbackRetrieve) | **GET** /callbacks/{callbackId} | Retrieve a callback |
| [**callbackUpdate**](Callbacks.md#callbackUpdate) | **PUT** /callbacks/{callbackId} | Update a callback |


<a name="callbackCallList"></a>
# **callbackCallList**
> CallbackCallCollection callbackCallList(xApiKey, callbackId, accept, limit, offset, sortOrder, sortFields, status)
...
import com.whispir.api.Callbacks;
...
public class Example {
  public static void main(String[] args) {
    ...
    Callbacks apiInstance = new Callbacks(defaultClient);
    ...
    try {
      CallbackCallCollection result = apiInstance.callbackCallList(xApiKey, callbackId, accept, limit, offset, sortOrder, sortFields, status);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Callbacks#callbackCallList");
...
[**CallbackCallCollection**](CallbackCallCollection.md)
...
<a name="callbackCallUpdate"></a>
# **callbackCallUpdate**
> callbackCallUpdate(xApiKey, callbackId, contentType, accept, id, callbackCall)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.callbackCallUpdate(xApiKey, callbackId, contentType, accept, id, callbackCall);
    } catch (ApiException e) {
      System.err.println("Exception when calling Callbacks#callbackCallUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="callbackCreate"></a>
# **callbackCreate**
> Callback callbackCreate(xApiKey, contentType, accept, callback)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Callback result = apiInstance.callbackCreate(xApiKey, contentType, accept, callback);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Callbacks#callbackCreate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="callbackDelete"></a>
# **callbackDelete**
> callbackDelete(xApiKey, contentType, accept, callbackId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String callbackId = "41048D9483C8CF2A"; // String | Enter Callback id.
    try {
      apiInstance.callbackDelete(xApiKey, contentType, accept, callbackId);
    } catch (ApiException e) {
      System.err.println("Exception when calling Callbacks#callbackDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="callbackList"></a>
# **callbackList**
> CallbackCollection callbackList(xApiKey, accept, limit, offset, sortOrder, sortFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String sortFields = "lastName,jobTitle"; // String | The fields that you require the ordering to be performed on. Multiple fields can be provided, separated by a comma.
    try {
      CallbackCollection result = apiInstance.callbackList(xApiKey, accept, limit, offset, sortOrder, sortFields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Callbacks#callbackList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
[**CallbackCollection**](CallbackCollection.md)
...
<a name="callbackRetrieve"></a>
# **callbackRetrieve**
> Callback callbackRetrieve(xApiKey, accept, callbackId)
...
public class Example {
  public static void main(String[] args) {
    ...
    String callbackId = "F98A1DD47C3CA1F5"; // String | Enter Callbacks Id
    try {
      Callback result = apiInstance.callbackRetrieve(xApiKey, accept, callbackId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Callbacks#callbackRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="callbackUpdate"></a>
# **callbackUpdate**
> callbackUpdate(xApiKey, callbackId, contentType, accept, callback)
...
public class Example {
  public static void main(String[] args) {
    ...
    String contentType = "application/vnd.whispir.api-callback-v1+json"; // String | Application specific mime-type.
    String accept = "application/vnd.whispir.api-callback-v1+json"; // String | Application specific mime-type.
    Callback callback = new Callback(); // Callback | The Callback object to update
    try {
      apiInstance.callbackUpdate(xApiKey, callbackId, contentType, accept, callback);
    } catch (ApiException e) {
      System.err.println("Exception when calling Callbacks#callbackUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **contentType** | **String**| Application specific mime-type. | [default to application/vnd.whispir.api-callback-v1+json] [enum: application/vnd.whispir.api-callback-v1+json, application/vnd.whispir.api-callback-v1+xml] |
| **accept** | **String**| Application specific mime-type. | [default to application/vnd.whispir.api-callback-v1+json] [enum: application/vnd.whispir.api-callback-v1+json, application/vnd.whispir.api-callback-v1+xml] |
| **callback** | [**Callback**](Callback.md)| The Callback object to update | [optional] |
