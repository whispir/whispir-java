...
|------------- | ------------- | -------------|
| [**getAuthVerification**](AuthApi.md#getAuthVerification) | **GET** /auth/verify | Verify an auth token |
| [**postAuth**](AuthApi.md#postAuth) | **POST** /auth | Create an auth token |


<a name="getAuthVerification"></a>
# **getAuthVerification**
> getAuthVerification(xApiKey, accept)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.getAuthVerification(xApiKey, accept);
    } catch (ApiException e) {
      System.err.println("Exception when calling AuthApi#getAuthVerification");
