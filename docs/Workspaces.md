...
|------------- | ------------- | -------------|
| [**workspaceCreate**](Workspaces.md#workspaceCreate) | **POST** /workspaces | Create a workspace |
| [**workspaceList**](Workspaces.md#workspaceList) | **GET** /workspaces | List workspaces |
| [**workspaceRetrieve**](Workspaces.md#workspaceRetrieve) | **GET** /workspaces/{workspaceId} | Retrieve a workspace |
| [**workspaceUpdate**](Workspaces.md#workspaceUpdate) | **PUT** /workspaces/{workspaceId} | Update a workspace |
...
import com.whispir.api.Workspaces;
...
public class Example {
  public static void main(String[] args) {
    ...
    Workspaces apiInstance = new Workspaces(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling Workspaces#workspaceCreate");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling Workspaces#workspaceList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling Workspaces#workspaceRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling Workspaces#workspaceUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
