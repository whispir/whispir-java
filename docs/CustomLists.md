...
|------------- | ------------- | -------------|
| [**customListList**](CustomLists.md#customListList) | **GET** /customlists | List custom lists |
| [**customListRetrieve**](CustomLists.md#customListRetrieve) | **GET** /customlists/{customlistId} | Retrieve a custom list |
...
import com.whispir.api.CustomLists;
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomLists apiInstance = new CustomLists(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling CustomLists#customListList");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling CustomLists#customListRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
