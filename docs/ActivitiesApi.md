...
|------------- | ------------- | -------------|
| [**activityCreate**](ActivitiesApi.md#activityCreate) | **POST** /activities | Create an activity |
| [**activityList**](ActivitiesApi.md#activityList) | **GET** /activities | List activities |
| [**activityWorkspaceList**](ActivitiesApi.md#activityWorkspaceList) | **GET** /workspaces/{workspaceId}/activities | List workspace activities |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ActivitiesApi#activityCreate");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ActivitiesApi#activityList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ActivitiesApi#activityWorkspaceList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
