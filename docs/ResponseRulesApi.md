...
|------------- | ------------- | -------------|
| [**deleteResponseRulesById**](ResponseRulesApi.md#deleteResponseRulesById) | **DELETE** /workspaces/{workspaceId}/responserules/{responseRuleId} | Delete a response rule |
| [**getResponseRules**](ResponseRulesApi.md#getResponseRules) | **GET** /workspaces/{workspaceId}/responserules | List response rules |
| [**getResponseRulesById**](ResponseRulesApi.md#getResponseRulesById) | **GET** /workspaces/{workspaceId}/responserules/{responseRuleId} | Retrieve a response rule |
| [**postResponseRules**](ResponseRulesApi.md#postResponseRules) | **POST** /workspaces/{workspaceId}/responserules | Create a response rule |
| [**putResponseRulesById**](ResponseRulesApi.md#putResponseRulesById) | **PUT** /workspaces/{workspaceId}/responserules/{responseRuleId} | Update a response rule |


<a name="deleteResponseRulesById"></a>
# **deleteResponseRulesById**
> deleteResponseRulesById(workspaceId, xApiKey, responseRuleId)
...
import com.whispir.api.ResponseRulesApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteResponseRulesById(workspaceId, xApiKey, responseRuleId);
    } catch (ApiException e) {
      System.err.println("Exception when calling ResponseRulesApi#deleteResponseRulesById");
...
# **getResponseRules**
> ResponseRuleCollection getResponseRules(workspaceId, xApiKey, accept, limit, offset, sortOrder, sortFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ResponseRuleCollection result = apiInstance.getResponseRules(workspaceId, xApiKey, accept, limit, offset, sortOrder, sortFields);
...
<a name="postResponseRules"></a>
# **postResponseRules**
> postResponseRules(workspaceId, xApiKey, contentType, accept, responseRule)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.postResponseRules(workspaceId, xApiKey, contentType, accept, responseRule);
    } catch (ApiException e) {
      System.err.println("Exception when calling ResponseRulesApi#postResponseRules");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="putResponseRulesById"></a>
# **putResponseRulesById**
> putResponseRulesById(workspaceId, xApiKey, contentType, accept, responseRuleId, responseRule)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.putResponseRulesById(workspaceId, xApiKey, contentType, accept, responseRuleId, responseRule);
    } catch (ApiException e) {
      System.err.println("Exception when calling ResponseRulesApi#putResponseRulesById");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
