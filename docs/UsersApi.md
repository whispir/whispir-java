...
| [**userRetrieve**](UsersApi.md#userRetrieve) | **GET** /users/{userId} | Retrieve a user |
| [**userUpdate**](UsersApi.md#userUpdate) | **PUT** /users/{userId} | Update a user |
| [**userWorkspaceList**](UsersApi.md#userWorkspaceList) | **GET** /workspaces/{workspaceId}/users | List workspace users |
| [**usersDelete**](UsersApi.md#usersDelete) | **DELETE** /users | Delete all users |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling UsersApi#userList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling UsersApi#userRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling UsersApi#userWorkspaceList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
