...
|------------- | ------------- | -------------|
| [**eventCreate**](Events.md#eventCreate) | **POST** /workspaces/{workspaceId}/events | Create an event |
| [**eventList**](Events.md#eventList) | **GET** /workspaces/{workspaceId}/events | List events |
| [**eventRetrieve**](Events.md#eventRetrieve) | **GET** /workspaces/{workspaceId}/events/{eventId} | Retrieve an event |
| [**eventUpdate**](Events.md#eventUpdate) | **PUT** /workspaces/{workspaceId}/events/{eventId} | Update an event |
...
public class Example {
  public static void main(String[] args) {
    ...
    Events apiInstance = new Events(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling Events#eventCreate");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling Events#eventList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling Events#eventRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling Events#eventUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
