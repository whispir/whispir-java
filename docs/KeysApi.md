...
|------------- | ------------- | -------------|
| [**keyCreate**](KeysApi.md#keyCreate) | **POST** /keys | Create a key |
| [**keyDelete**](KeysApi.md#keyDelete) | **DELETE** /keys/{keyId} | Delete a key |
| [**keyList**](KeysApi.md#keyList) | **GET** /keys | List keys |
| [**keyRetrieve**](KeysApi.md#keyRetrieve) | **GET** /keys/{keyId} | Retrieve a key |
| [**keyUpdate**](KeysApi.md#keyUpdate) | **PUT** /keys/{keyId} | Update a key |


<a name="keyCreate"></a>
# **keyCreate**
> Key keyCreate(xApiKey, accept, contentType, key)
...
import com.whispir.api.KeysApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    String accept = "application/json"; // String | Application specific mime-type.
    String contentType = "application/json"; // String | Application specific mime-type.
    Key key = new Key(); // Key | Key object to be created
    try {
      Key result = apiInstance.keyCreate(xApiKey, accept, contentType, key);
...
| **accept** | **String**| Application specific mime-type. | [default to application/json] [enum: application/json] |
| **contentType** | **String**| Application specific mime-type. | [default to application/json] [enum: application/json] |
| **key** | [**Key**](Key.md)| Key object to be created | |
...
<a name="keyDelete"></a>
# **keyDelete**
> keyDelete(xApiKey, keyId)

Delete a key

Deletes the speficied key
...
public class Example {
  public static void main(String[] args) {
    ...
    KeysApi apiInstance = new KeysApi(defaultClient);
    String xApiKey = "xApiKey_example"; // String | The API key for authentication.
    String keyId = "7f6a3d23-11f3-406c-9d72-8e8a80c248e4"; // String | The id of the key to be deleted
    try {
      apiInstance.keyDelete(xApiKey, keyId);
    } catch (ApiException e) {
...
<a name="keyList"></a>
# **keyList**
> KeyCollection keyList(xApiKey, accept, limit, offset, sortOrder, sortFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      KeyCollection result = apiInstance.keyList(xApiKey, accept, limit, offset, sortOrder, sortFields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling KeysApi#keyList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="keyRetrieve"></a>
# **keyRetrieve**
> Key keyRetrieve(xApiKey, keyId, accept, sortOrder, sortFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    KeysApi apiInstance = new KeysApi(defaultClient);
    String xApiKey = "xApiKey_example"; // String | The API key for authentication.
    String keyId = "7f6a3d23-11f3-406c-9d72-8e8a80c248e4"; // String | The key id to fetch
    String accept = "application/json"; // String | Application specific mime-type.
    String sortOrder = "asc"; // String | The order in which you require the results to be returned. Either ‘asc’ or ‘desc’
    String sortFields = "lastName,jobTitle"; // String | The fields that you require the ordering to be performed on. Multiple fields can be provided, separated by a comma.
    try {
      Key result = apiInstance.keyRetrieve(xApiKey, keyId, accept, sortOrder, sortFields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling KeysApi#keyRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
|------------- | ------------- | ------------- | -------------|
| **xApiKey** | **String**| The API key for authentication. | |
| **keyId** | **String**| The key id to fetch | |
| **accept** | **String**| Application specific mime-type. | [default to application/json] [enum: application/json] |
| **sortOrder** | **String**| The order in which you require the results to be returned. Either ‘asc’ or ‘desc’ | [optional] [enum: asc, desc] |
| **sortFields** | **String**| The fields that you require the ordering to be performed on. Multiple fields can be provided, separated by a comma. | [optional] |
...
<a name="keyUpdate"></a>
# **keyUpdate**
> keyUpdate(xApiKey, keyId, accept, contentType, key)
...
public class Example {
  public static void main(String[] args) {
    ...
    KeysApi apiInstance = new KeysApi(defaultClient);
    String xApiKey = "xApiKey_example"; // String | The API key for authentication.
    String keyId = "7f6a3d23-11f3-406c-9d72-8e8a80c248e4"; // String | The key id to update
    String accept = "application/json"; // String | Application specific mime-type.
    String contentType = "application/json"; // String | Application specific mime-type.
    Key key = new Key(); // Key | Key object that needs to be updated
    try {
      apiInstance.keyUpdate(xApiKey, keyId, accept, contentType, key);
    } catch (ApiException e) {
...
| **accept** | **String**| Application specific mime-type. | [default to application/json] [enum: application/json] |
| **contentType** | **String**| Application specific mime-type. | [default to application/json] [enum: application/json] |
| **key** | [**Key**](Key.md)| Key object that needs to be updated | |
