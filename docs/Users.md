...
|------------- | ------------- | -------------|
| [**userCreate**](Users.md#userCreate) | **POST** /users | Create a user |
| [**userDelete**](Users.md#userDelete) | **DELETE** /users/{userId} | Delete a user |
| [**userList**](Users.md#userList) | **GET** /users | List users |
| [**userRetrieve**](Users.md#userRetrieve) | **GET** /users/{userId} | Retrieve a user |
| [**userUpdate**](Users.md#userUpdate) | **PUT** /users/{userId} | Update a user |
| [**userWorkspaceList**](Users.md#userWorkspaceList) | **GET** /workspaces/{workspaceId}/users | List workspace users |
| [**usersDelete**](Users.md#usersDelete) | **DELETE** /users | Delete all users |


<a name="userCreate"></a>
# **userCreate**
> User userCreate(xApiKey, contentType, accept, user)
...
public class Example {
  public static void main(String[] args) {
    ...
    Users apiInstance = new Users(defaultClient);
    ...
    try {
      User result = apiInstance.userCreate(xApiKey, contentType, accept, user);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Users#userCreate");
...
<a name="userDelete"></a>
# **userDelete**
> userDelete(xApiKey, contentType, accept, userId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.userDelete(xApiKey, contentType, accept, userId);
    } catch (ApiException e) {
      System.err.println("Exception when calling Users#userDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="userList"></a>
# **userList**
> UserCollection userList(xApiKey, accept, fieldname, sortOrder, sortFields, limit, offset)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UserCollection result = apiInstance.userList(xApiKey, accept, fieldname, sortOrder, sortFields, limit, offset);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Users#userList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="userRetrieve"></a>
# **userRetrieve**
> User userRetrieve(xApiKey, accept, userId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      User result = apiInstance.userRetrieve(xApiKey, accept, userId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Users#userRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="userUpdate"></a>
# **userUpdate**
> userUpdate(xApiKey, contentType, accept, userId, user)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.userUpdate(xApiKey, contentType, accept, userId, user);
    } catch (ApiException e) {
      System.err.println("Exception when calling Users#userUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a name="userWorkspaceList"></a>
# **userWorkspaceList**
> UserCollection userWorkspaceList(workspaceId, xApiKey, accept, sortOrder, sortFields, limit, offset)
...
public class Example {
  public static void main(String[] args) {
    ...
    BigDecimal offset = new BigDecimal("0"); // BigDecimal | The record number to start returning from.
    try {
      UserCollection result = apiInstance.userWorkspaceList(workspaceId, xApiKey, accept, sortOrder, sortFields, limit, offset);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling Users#userWorkspaceList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **usersDelete**
> usersDelete(xApiKey, contentType, accept)
...
public class Example {
  public static void main(String[] args) {
    ...
    String accept = "application/vnd.whispir.user-v1+json"; // String | User accept.
    try {
      apiInstance.usersDelete(xApiKey, contentType, accept);
    } catch (ApiException e) {
      System.err.println("Exception when calling Users#usersDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
