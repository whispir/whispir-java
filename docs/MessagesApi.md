...
|------------- | ------------- | -------------|
| [**messageCreate**](MessagesApi.md#messageCreate) | **POST** /workspaces/{workspaceId}/messages | Send a message |
| [**messageList**](MessagesApi.md#messageList) | **GET** /workspaces/{workspaceId}/messages | List messages |
| [**messageResponseList**](MessagesApi.md#messageResponseList) | **GET** /workspaces/{workspaceId}/messages/{messageId}/messageresponses | List responses for a sent message |
| [**messageRetrieve**](MessagesApi.md#messageRetrieve) | **GET** /workspaces/{workspaceId}/messages/{messageId} | Retrieve a message |
| [**messageStatusList**](MessagesApi.md#messageStatusList) | **GET** /workspaces/{workspaceId}/messages/{messageId}/messagestatus | List message status for a sent message |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MessagesApi#messageList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MessagesApi#messageResponseList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MessagesApi#messageRetrieve");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MessagesApi#messageStatusList");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
