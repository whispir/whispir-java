...
# **getCustomLists**
> CustomListCollection getCustomLists(xApiKey, accept, limit, offset, sortOrder, sortFields, name, type)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CustomListCollection result = apiInstance.getCustomLists(xApiKey, accept, limit, offset, sortOrder, sortFields, name, type);
