...
public class ActivitiesApi {
     ...
     * @param workspace /activities?workspace&#x3D;Whispir. (optional, default to {{workspaceName}})
     * @param status /activities?status&#x3D;Successful (optional)
     * @param description /activities?description&#x3D;Imported (optional)
     * @param startTime The date and time to start searching from in the format:dd/mm/yyyy hh:mm. This will search on the &#x60;time&#x60; field &lt;p&gt;/activities?startTime&#x3D;01/01/2015%2000:00&lt;/p&gt; (optional, default to {{startTime}})
     * @param endTime The date and time to start searching from in the format:dd/mm/yyyy hh:mm &lt;p&gt;/activities?endTime&#x3D;01/01/2015%2000:00&lt;/p&gt; (optional, default to {{endTime}})
     ...
     */
    public void getWorkspaceActivities(String workspaceId, String xApiKey, String accept, BigDecimal limit, BigDecimal offset, String sortOrder, String sortFields) throws ApiException {
        getWorkspaceActivitiesWithHttpInfo(workspaceId, xApiKey, accept, limit, offset, sortOrder, sortFields);
    }
     ...
     */
    public ApiResponse<Void> getWorkspaceActivitiesWithHttpInfo(String workspaceId, String xApiKey, String accept, BigDecimal limit, BigDecimal offset, String sortOrder, String sortFields) throws ApiException {
     ...
     */
    public okhttp3.Call getWorkspaceActivitiesAsync(String workspaceId, String xApiKey, String accept, BigDecimal limit, BigDecimal offset, String sortOrder, String sortFields, final ApiCallback<Void> _callback) throws ApiException {
