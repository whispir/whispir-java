...
public class GetDistributionLists200ResponseDistributionListsInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetDistributionLists200ResponseDistributionListsInner.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetDistributionLists200ResponseDistributionListsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetDistributionLists200ResponseDistributionListsInner' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetDistributionLists200ResponseDistributionListsInner>() {
                @Override
                public void write(JsonWriter out, GetDistributionLists200ResponseDistributionListsInner value) throws IOException {
                ...
                @Override
                public GetDistributionLists200ResponseDistributionListsInner read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        GetDistributionLists200ResponseDistributionListsInner ret = new GetDistributionLists200ResponseDistributionListsInner();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for GetDistributionLists200ResponseDistributionListsInner: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetDistributionLists200ResponseDistributionListsInner() {
        super("oneOf", Boolean.FALSE);
    }

    public GetDistributionLists200ResponseDistributionListsInner(Distributionlist o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetDistributionLists200ResponseDistributionListsInner(Dynamicdistributionlist o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return GetDistributionLists200ResponseDistributionListsInner.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetDistributionLists200ResponseDistributionListsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for GetDistributionLists200ResponseDistributionListsInner with oneOf schemas: Distributionlist, Dynamicdistributionlist. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of GetDistributionLists200ResponseDistributionListsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetDistributionLists200ResponseDistributionListsInner
  * @throws IOException if the JSON string is invalid with respect to GetDistributionLists200ResponseDistributionListsInner
  */
  public static GetDistributionLists200ResponseDistributionListsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetDistributionLists200ResponseDistributionListsInner.class);
  }

 /**
  * Convert an instance of GetDistributionLists200ResponseDistributionListsInner to an JSON string
  *
  * @return JSON string
  */
