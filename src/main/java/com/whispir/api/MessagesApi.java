...
import com.whispir.model.MessageResponse;
...
public class MessagesApi {
    ...
    public okhttp3.Call getMessageResponsesByIdCall(String workspaceId, String xApiKey, String accept, String messageId, BigDecimal limit, BigDecimal offset, String sortOrder, String sortFields, String view, String filter, final ApiCallback _callback) throws ApiException {
        ...
        final String[] localVarAccepts = {
            "application/vnd.whispir.messageresponse-v1+json", "application/json"
        };
        final String localVarAccept = localVarApiClient.selectHeaderAccept(localVarAccepts);
        if (localVarAccept != null) {
            localVarHeaderParams.put("Accept", localVarAccept);
     ...
     */
    public MessageResponse getMessageResponsesById(String workspaceId, String xApiKey, String accept, String messageId, BigDecimal limit, BigDecimal offset, String sortOrder, String sortFields, String view, String filter) throws ApiException {
        ApiResponse<MessageResponse> localVarResp = getMessageResponsesByIdWithHttpInfo(workspaceId, xApiKey, accept, messageId, limit, offset, sortOrder, sortFields, view, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MessageResponse> getMessageResponsesByIdWithHttpInfo(String workspaceId, String xApiKey, String accept, String messageId, BigDecimal limit, BigDecimal offset, String sortOrder, String sortFields, String view, String filter) throws ApiException {
     ...
     */
    public okhttp3.Call getMessageResponsesByIdAsync(String workspaceId, String xApiKey, String accept, String messageId, BigDecimal limit, BigDecimal offset, String sortOrder, String sortFields, String view, String filter, final ApiCallback<MessageResponse> _callback) throws ApiException {
     ...
     */
    public MessageCollection getMessages(String workspaceId, String xApiKey, String accept, BigDecimal limit, BigDecimal offset, String sortOrder, String sortFields) throws ApiException {
        ApiResponse<MessageCollection> localVarResp = getMessagesWithHttpInfo(workspaceId, xApiKey, accept, limit, offset, sortOrder, sortFields);
        return localVarResp.getData();
    }
     ...
     * @param sortOrder The order in which you require the results to be returned. Either ‘asc’ or ‘desc’ (optional)
     * @param sortFields The fields that you require the ordering to be performed on. Multiple fields can be provided, separated by a comma. (optional)
     * @return ApiResponse&lt;MessageCollection&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<MessageCollection> getMessagesWithHttpInfo(String workspaceId, String xApiKey, String accept, BigDecimal limit, BigDecimal offset, String sortOrder, String sortFields) throws ApiException {
     ...
     */
    public okhttp3.Call getMessagesAsync(String workspaceId, String xApiKey, String accept, BigDecimal limit, BigDecimal offset, String sortOrder, String sortFields, final ApiCallback<MessageCollection> _callback) throws ApiException {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The response code for a message that is accepted for scheduled delivery. </td><td>  * Content-Type -  <br>  * Content-Length -  <br>  * Access-Control-Allow-Origin -  <br>  * Cache-Control -  <br>  * Expires -  <br>  * Location -  <br>  </td></tr>
        <tr><td> 202 </td><td> The response code for a message that is accepted for immediate delivery. </td><td>  * Content-Type -  <br>  * Content-Length -  <br>  * Access-Control-Allow-Origin -  <br>  * Cache-Control -  <br>  * Expires -  <br>  * Location -  <br>  </td></tr>
        <tr><td> 400 </td><td> Invalid or missing request parameters.  Inspect the request parameters and ensure that all required parameters are supplied.  Note the error text in the response and update the request accordingly. </td><td>  * Access-Control-Allow-Origin -  <br>  * Content-Length -  <br>  * Content-Type -  <br>  * Cache-Control -  <br>  * Expires -  <br>  </td></tr>
        <tr><td> 401 </td><td> Invalid or no credentials passed in the request.  Inspect the authorisation header and ensure that a valid authentication has been provided. </td><td>  * Access-Control-Allow-Origin -  <br>  * Content-Length -  <br>  * Content-Type -  <br>  * Cache-Control -  <br>  * Expires -  <br>  </td></tr>
        <tr><td> 403 </td><td> Authorisation credentials passed and accepted but the account doesn&#39;t have permission.  * Inspect the authorisation header and ensure that a valid authentication has been provided. * Returned when HTTP is used instead of HTTPS. * Returned when invalid API key is used. * Returned when you have tried to make more API calls than your allowed quota (QPS). Refer to API rate limits. </td><td>  * Access-Control-Allow-Origin -  <br>  * Content-Length -  <br>  * Content-Type -  <br>  * Cache-Control -  <br>  * Expires -  <br>  </td></tr>
        <tr><td> 404 </td><td> The requested URL doesn&#39;t exist.  The requested resource was not found. Inspect the ID in the URL that was used and ensure that it&#39;s valid.  Also, inspect the Accept and Content-Type headers that are being used to make sure they’re correct for the URL that is being requested. </td><td>  * Access-Control-Allow-Origin -  <br>  * Content-Length -  <br>  * Content-Type -  <br>  * Cache-Control -  <br>  * Expires -  <br>  </td></tr>
