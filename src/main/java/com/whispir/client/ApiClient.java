...
import com.whispir.client.auth.HttpBearerAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.au.whispir.com";
    ...
    new ServerConfiguration(
      "https://api.ap1.whispir.com",
      "AP1",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.nz.whispir.com",
      "New Zealand",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.us.whispir.com",
      "United States",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.it.whispir.com",
      "IT",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.education.whispir.com",
      "Education",
      new HashMap<String, ServerVariable>()
    )
  ));
    ...
    private void init() {
        ...
        setUserAgent(String.format("whispir-java-%s", Version.VERSION));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.au.whispir.com
     ...
     * @return a {@link com.whispir.client.ApiClient} object
     */
     ...
     * @throws com.whispir.client.ApiException If fail to deserialize response body, i.e. cannot read response body
        ...
        if (isNonJsonMimeResponse(response.request(), contentType)) {
            ...
            if (location != null) {
                ...
                try {
                    ...
                    jsonObject.addProperty("docId", matcher.group(1));
     ...
     * @throws com.whispir.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.whispir.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.whispir.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.whispir.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.whispir.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.whispir.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.whispir.client.ApiException If fail to serialize the request body object into a string
     */
